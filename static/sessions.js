...
const _MESSAGING_RAW_SOURCES = new Set(['weixin', 'telegram', 'discord', 'slack', 'email', 'wecom', 'wecom_callback', 'line', 'matrix']);
...
function ensureSessionEventsSSE(){
  ...
  try{
    ...
    _sessionEventsSSE = new EventSource('api/sessions/events' + window._hermesTabQsFirst());
...
function startGatewaySSE(){
  ...
  if(_sidebarSseBackgrounded()) return;
  try{
    _gatewaySSE = new EventSource('api/sessions/gateway/stream' + window._hermesTabQsFirst());
